...
Paid deals in gaming-deals can receive optional GoCDKeys comparisons from Instant Gaming or DealGecko; free-games and free/unknown-price offers are always excluded. Enable the existing GOCDKEYS_ENABLED setting and Message Content Intent after reviewing [paid-deal setup](GOCDKEYS.md). Route free and paid posts separately in DealGecko.
